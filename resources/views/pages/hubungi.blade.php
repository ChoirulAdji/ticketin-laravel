@extends('layouts.app')
@section('title','Hubungi Kami — TicketIn')
  ...
  <div class="bg-navy-deep relative overflow-hidden">
    ...
    <div class="max-w-7xl mx-auto px-6 py-14 relative">
      <div class="flex items-center gap-2 text-white/50 text-sm mb-3">
        <a href="{{ route('dashboard') }}" class="hover:text-gold transition">Beranda</a>
  ...
  <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
    ...
    <div class="fade-in visible">
      ...
      <div class="space-y-3 mb-8">
        @foreach([['cs@ticketin.com','Customer Service'],['marketing@ticketin.com','Marketing'],['partnership@ticketin.com','Kerjasama & Partnership']] as [$email,$label])
        <a href="mailto:{{ $email }}" class="contact-card flex items-center gap-4 bg-gray-50 border border-gray-100 rounded-xl px-4 py-3 group">
          ...
          <div>
            ...
            <p class="text-navy-deep font-semibold text-sm">{{ $email }}</p>
          </div>
        </a>
        @endforeach
      </div>
