...
<section class="max-w-7xl mx-auto px-6 py-16 space-y-16">
  ...
  <div class="fade-in visible">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-3 gap-6">
      @foreach([['Iqbal Maulana Difangga'],['Muhammad Rasya D.S'],['Choirul Wahyu Adji']] as [$nama,])
  ...
  <div class="fade-in visible text-center bg-white rounded-2xl shadow-sm border border-gray-100 p-10">
    ...
    <div class="flex gap-3 justify-center flex-wrap">
      <a href="{{ route('events.index') }}" class="bg-gold text-navy-deep font-bold px-6 py-3 rounded-xl hover:bg-gold-light transition-all text-sm shadow-sm"> Temukan Event</a>
      @guest
