...
<head>
  ...
  <title>@yield('title','TicketIn')</title>
...
<body class="min-h-screen flex flex-col">
  ...
  <header class="fixed top-0 left-0 w-full bg-navy-mid text-white shadow-lg z-50">
    <div class="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center">
      ...
      <nav class="hidden md:flex gap-8">
        <a href="{{ route('dashboard') }}" class="nav-link text-white/70 hover:text-gold font-medium text-sm">Beranda</a>
        <a href="{{ route('hubungi') }}" class="nav-link text-white/70 hover:text-gold font-medium text-sm">Hubungi Kami</a>
      </nav>
    ...
    <div id="mobile-menu" class="bg-navy-mid border-t border-white/10">
      <nav class="flex flex-col px-6 py-4 gap-3">
        <a href="{{ route('dashboard') }}" class="hover:text-gold transition text-sm font-medium">Beranda</a>
        <a href="{{ route('hubungi') }}" class="hover:text-gold transition text-sm font-medium">Hubungi Kami</a>
        @yield('auth-switch-mobile')
      </nav>
    </div>
  </header>
  ...
  <footer class="text-center py-5 text-white/30 text-xs border-t border-white/5">
    © {{ date('Y') }} TicketIn. All rights reserved.
  </footer>
