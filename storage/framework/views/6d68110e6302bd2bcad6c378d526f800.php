<?php $__env->startSection('title', 'Daftar Jadi Pengelola Event — TicketIn'); ?>
...
<div class="pt-24 max-w-4xl mx-auto px-6 py-10">
  ...
  <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
      ...
      <div class="bg-navy-deep rounded-2xl p-6 text-white sticky top-28">
        ...
        <div class="space-y-3">
          ...
          <div class="flex items-start gap-3 p-3 rounded-xl" style="background:rgba(255,255,255,.08)">
            ...
            <div>
              <p class="font-semibold text-sm"><?php echo e($title); ?></p>
              <p class="text-white/60 text-xs mt-0.5"><?php echo e($desc); ?></p>
            </div>
          </div>
    ...
    <div class="lg:col-span-2">
      ...
      <form method="POST" action="<?php echo e(route('eo.store')); ?>" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
        ...
        <div class="step-card">
          ...
          <div class="space-y-4">
            ...
            <div class="grid grid-cols-2 gap-4">
              <div>
                ...
                <select name="jenis_entitas" class="form-input px-4 py-3 text-sm" required>
                  ...
                  <?php $__currentLoopData = ['perorangan'=>'Perorangan','cv'=>'CV / Firma','pt'=>'PT','yayasan'=>'Yayasan / NGO','komunitas'=>'Komunitas']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $v=>$l): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <option value="<?php echo e($v); ?>" <?php echo e(old('jenis_entitas')===$v?'selected':''); ?>><?php echo e($l); ?></option>
                  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
              </div>
              <div>
                ...
                <select name="skala_event" class="form-input px-4 py-3 text-sm" required>
                  ...
                  <?php $__currentLoopData = ['kecil'=>'Kecil (<100 orang)','menengah'=>'Menengah (100-1K)','besar'=>'Besar (>1.000)']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $v=>$l): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <option value="<?php echo e($v); ?>" <?php echo e(old('skala_event')===$v?'selected':''); ?>><?php echo e($l); ?></option>
                  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
              </div>
            </div>
            <div>
              ...
              <input type="text" name="alamat_organisasi" value="<?php echo e(old('alamat_organisasi')); ?>"
            ...
            <div class="grid grid-cols-2 gap-4">
              <div>
                ...
                <input type="tel" name="no_hp_bisnis" value="<?php echo e(old('no_hp_bisnis')); ?>"
        ...
        <div class="step-card">
          ...
          <div class="space-y-4">
            <div class="grid grid-cols-2 gap-4">
              <div>
                ...
                <select name="bank" class="form-input px-4 py-3 text-sm" required>
                  ...
                  <?php $__currentLoopData = ['bca'=>'BCA','bni'=>'BNI','bri'=>'BRI','mandiri'=>'Mandiri','bsi'=>'BSI','cimb'=>'CIMB Niaga','lain'=>'Bank Lainnya']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $v=>$l): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <option value="<?php echo e($v); ?>" <?php echo e(old('bank')===$v?'selected':''); ?>><?php echo e($l); ?></option>
                  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
              </div>
              <div>
            ...
            <div>
              ...
              <input type="text" name="nama_rekening" value="<?php echo e(old('nama_rekening')); ?>"
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Application\Software\XAMPP\htdocs\ticketin-laravel\resources\views/eo/daftar.blade.php ENDPATH**/ ?>