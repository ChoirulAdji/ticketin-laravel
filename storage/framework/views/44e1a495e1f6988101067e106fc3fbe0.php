<?php $__env->startSection('title','TicketIn — Masuk'); ?>
<?php $__env->startSection('auth-switch'); ?>
  Belum punya akun? <a href="<?php echo e(route('register')); ?>" class="text-gold font-semibold hover:underline">Daftar</a>
<?php $__env->stopSection(); ?>
<?php $__env->startSection('auth-switch-mobile'); ?>
  <a href="<?php echo e(route('register')); ?>" class="text-gold font-semibold text-sm">Daftar Sekarang →</a>
<?php $__env->stopSection(); ?>
...
<div class="w-full max-w-md card-enter">
  <div class="glass-card rounded-2xl p-8 md:p-10">
    ...
    <!-- Form -->
    <form id="login-form" method="POST" action="<?php echo e(route('login')); ?>" class="space-y-5">
      <?php echo csrf_field(); ?>
    ...
    <p class="text-center text-white/50 text-sm">
      Belum punya akun?
      <a href="<?php echo e(route('register')); ?>" class="text-gold font-semibold hover:text-gold-light hover:underline transition-colors ml-1">Daftar sekarang</a>
    </p>
  </div>
</div>
...
<?php echo $__env->make('layouts.auth', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Application\Software\XAMPP\htdocs\ticketin-laravel\resources\views/auth/login.blade.php ENDPATH**/ ?>