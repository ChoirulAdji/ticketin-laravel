...
<div class="wrapper">
  <div class="card">
    ...
    <div class="body">
      <div class="alert-box">
        ...
        <div>
          ...
          <p><?php echo e($order->user->nama_lengkap); ?> baru saja memesan tiket <strong><?php echo e($order->event->judul); ?></strong>.</p>
        </div>
      </div>
      ...
      <div class="stat-grid">
        <div class="stat">
          <div class="num"><?php echo e($order->total_qty); ?></div>
          <div class="lbl">Tiket</div>
        </div>
        <div class="stat">
          <div class="num" style="font-size:14px;">Rp <?php echo e(number_format($order->total_harga, 0, ',', '.')); ?></div>
          <div class="lbl">Total</div>
        </div>
        <div class="stat">
          <div class="num" style="color:#d97706;">⏳</div>
          <div class="lbl"><?php echo e(ucfirst($order->status)); ?></div>
        </div>
      </div>
      ...
      <div style="background:#f9fafb;border-radius:10px;padding:16px 20px;margin-bottom:20px;">
        <div class="detail-row">
          ...
          <span class="val"><?php echo e($order->user->nama_lengkap); ?></span>
        </div>
        <div class="detail-row">
          <span class="lbl">Email</span>
          <span class="val"><?php echo e($order->user->email); ?></span>
        </div>
        <div class="detail-row">
          <span class="lbl">No. HP</span>
          <span class="val"><?php echo e($order->user->no_hp ? '+62'.$order->user->no_hp : '-'); ?></span>
        </div>
        <div class="detail-row">
          <span class="lbl">Kode Order</span>
          <span class="val" style="font-family:monospace;color:#102A71;"><?php echo e($order->order_code); ?></span>
        </div>
        <div class="detail-row">
          <span class="lbl">Metode Bayar</span>
          <span class="val"><?php echo e(strtoupper($order->metode_bayar)); ?></span>
        </div>
      </div>
      ...
      <div style="background:#f9fafb;border-radius:10px;padding:16px 20px;margin-bottom:20px;">
        ...
        <div class="detail-row">
          <span class="lbl"><?php echo e($item->ticketCategory->nama_kategori); ?></span>
          <span class="val"><?php echo e($item->qty); ?>x — Rp <?php echo e(number_format($item->harga_satuan * $item->qty, 0, ',', '.')); ?></span>
        </div>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
      </div>

      <a href="<?php echo e(url('/pengelola')); ?>" class="cta">Buka Dashboard EO →</a>
    ...
    <div class="footer">
      <p>Email ini dikirim otomatis oleh <a href="<?php echo e(config('app.url')); ?>">TicketIn</a>.</p>
    </div>
  </div>
</div>
</body>
</html>
<?php /**PATH D:\Application\Software\XAMPP\htdocs\ticketin-laravel\resources\views/emails/orders/notif-eo.blade.php ENDPATH**/ ?>