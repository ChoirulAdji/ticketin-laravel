    ...
    <form method="POST" action="<?php echo e(route('profile.update')); ?>" enctype="multipart/form-data" class="space-y-5">
      ...
      <div>
        ...
        <div class="form-input px-4 py-3 text-sm text-gray-400 cursor-not-allowed bg-gray-50">
          <?php echo e($user->role==='pengelola' ? '🎭 Pengelola Event (EO)' : ($user->role==='admin' ? '👑 Admin' : '🎟️ Pembeli Tiket')); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Application\Software\XAMPP\htdocs\ticketin-laravel\resources\views/profile/edit.blade.php ENDPATH**/ ?>