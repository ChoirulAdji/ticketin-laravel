...
<?php if(auth()->check() && auth()->user()->role === 'admin' && $event->status !== 'published'): ?>
<div class="bg-amber-500 text-white text-sm font-semibold text-center py-2.5 px-4 flex items-center justify-center gap-2">
  ...
  MODE PREVIEW ADMIN — Status: <strong class="ml-1 uppercase"><?php echo e($event->status); ?></strong>
  <a href="<?php echo e(route('admin.events')); ?>" class="ml-4 text-xs underline hover:no-underline">← Kembali ke panel admin</a>
</div>
<?php endif; ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\ticketin-laravel\resources\views/events/show.blade.php ENDPATH**/ ?>