...
<div class="max-w-7xl mx-auto px-4 py-8">
  ...
  <div class="flex items-center justify-between mb-6 flex-wrap gap-3">
    ...
    <a href="<?php echo e(route('pengelola.laporan.export', request()->query())); ?>"
  ...
  <form method="GET" action="<?php echo e(route('pengelola.laporan')); ?>" class="bg-white rounded-2xl border border-gray-100 shadow-sm p-5 mb-6">
    <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-3">
      ...
      <div class="flex items-end gap-2">
        ...
        <a href="<?php echo e(route('pengelola.laporan')); ?>" class="px-3 py-2 border border-gray-200 text-gray-500 rounded-xl hover:bg-gray-50 transition text-sm">Reset</a>
      </div>
    </div>
  </form>
      ...
      <table class="w-full text-sm">
        ...
        <tbody class="divide-y divide-gray-50">
          ...
          <tr class="hover:bg-gray-50 transition">
            ...
            <td class="px-4 py-3 text-right text-xs text-red-500 font-semibold">- Rp <?php echo e(number_format($order->biaya_layanan,0,',','.')); ?></td>
            <td class="px-4 py-3 text-right font-bold text-xs text-green-600">Rp <?php echo e(number_format($order->pendapatan_eo,0,',','.')); ?></td>
...
<?php echo $__env->make('layouts.pengelola', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\ticketin-laravel\resources\views/pengelola/laporan.blade.php ENDPATH**/ ?>