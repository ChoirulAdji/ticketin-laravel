  ...
  <div class="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
    <div class="stat-card">
      <div class="flex items-center justify-between mb-3">
        ...
        <?php if($events->where('status','pending_review')->count() > 0): ?>
        <span class="text-xs font-semibold text-amber-600 bg-amber-50 px-2 py-0.5 rounded-full"><?php echo e($events->where('status','pending_review')->count()); ?> Review</span>
        <?php endif; ?>
      </div>
    ...
    <div class="bg-white border border-gray-100 rounded-2xl p-6 shadow-sm">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6 items-start">
        ...
        <div class="bg-white border border-gray-100 rounded-2xl p-5 shadow-sm">
          ...
          <?php if($pieKategoriTiket->isEmpty()): ?>
          ...
          <div class="mt-3 space-y-1">
            <?php $__currentLoopData = $pieKategoriTiket; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kat => $qty): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="flex items-center justify-between text-xs">
              <span class="text-gray-600 font-medium"><?php echo e($kat); ?></span>
              <span class="font-bold text-navy-mid"><?php echo e($qty); ?> tiket</span>
            </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
          </div>
          <?php endif; ?>
        ...
        <div class="bg-white border border-gray-100 rounded-2xl p-5 shadow-sm">
          ...
          <?php if($piePesananStatus->isEmpty()): ?>
          ...
          <div class="mt-3 space-y-1">
            <?php $__currentLoopData = $piePesananStatus; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $status => $total): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="flex items-center justify-between text-xs">
        ...
        <div class="bg-gray-50 border border-gray-100 rounded-xl p-4">
          <div class="flex items-center justify-between mb-2">
            ...
            <span class="text-xs font-bold px-2 py-0.5 rounded-full
              ...
              <?php echo e($event->status==='published'      ? ' Live' :
            ...
            <?php elseif($event->status==='draft' && $event->catatan_admin): ?>
            <p class="text-xs text-red-500 mt-1">Ditolak: <?php echo e($event->catatan_admin); ?></p>
            <?php endif; ?>
          </div>
          <div class="flex items-center gap-4 text-xs text-gray-500 mb-2">
            <span> <?php echo e($soldQty); ?>/<?php echo e($totalKuota); ?> tiket</span>
...
<?php echo $__env->make('layouts.pengelola', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\ticketin-laravel\resources\views/pengelola/dashboard.blade.php ENDPATH**/ ?>