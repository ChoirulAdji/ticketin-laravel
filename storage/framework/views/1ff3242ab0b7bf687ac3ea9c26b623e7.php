<div class="event-card bg-white rounded-xl shadow-md overflow-hidden cursor-pointer group flex flex-col relative"
     style="height:380px;"
     onclick="location.href='<?php echo e(route('events.show', $event)); ?>'">
  ...
  <div class="p-4 flex flex-col flex-1 min-h-0">
    <div class="mb-2 flex-shrink-0">
      <span class="bg-navy-mid/10 text-navy-mid text-xs px-2 py-0.5 rounded-full font-medium"><?php echo e($event->kategori); ?></span>
    </div>
    ...
    <p class="text-xs text-gray-400 flex items-center gap-1 flex-shrink-0 mb-0.5">
      ...
      <span><?php echo e($event->tanggal_waktu->format('d M Y')); ?>, <?php echo e($event->tanggal_waktu->format('H:i')); ?></span>
    </p>
    ...
    <p class="text-xs text-gray-400 flex items-center gap-1 flex-shrink-0 mb-1">
      ...
      <span class="truncate"><?php echo e($event->lokasi_kota); ?></span>
    </p>
    ...
    <div class="flex items-center justify-between pt-3 border-t border-gray-100 flex-shrink-0">
      <div>
        <?php if(($event->harga_termurah ?? 0) == 0): ?>
          <p class="text-green-600 font-bold text-sm">GRATIS</p>
        <?php else: ?>
          <p class="text-gray-400 text-xs">Mulai dari</p>
          <p class="text-navy-mid font-bold text-sm">Rp <?php echo e(number_format($event->harga_termurah, 0, ',', '.')); ?></p>
        <?php endif; ?>
      </div>
...
<?php /**PATH D:\Application\Software\XAMPP\htdocs\ticketin-laravel\resources\views/partials/event-card.blade.php ENDPATH**/ ?>