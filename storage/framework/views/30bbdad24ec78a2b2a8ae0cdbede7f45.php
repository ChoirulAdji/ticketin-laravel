        ...
        <tr class="hover:bg-gray-50 transition-colors">
          ...
          <td class="px-4 py-4">
            <span class="text-xs font-semibold px-2 py-1 rounded-full
              ...
              <?php echo e($user->role==='admin'?'👑 Admin':($user->role==='pengelola'?'🎭 EO':'🎟️ Pembeli')); ?>
  ...
  <div class="modal-box p-6">
    ...
    <form method="POST" id="role-form">
      ...
      <div class="space-y-2 mb-5">
        <?php $__currentLoopData = ['user'=>['🎟️ Pembeli','Bisa beli tiket event'],'pengelola'=>['🎭 Pengelola EO','Bisa buat dan kelola event'],'admin'=>['👑 Admin','Akses penuh ke seluruh platform']]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role=>[$label,$desc]): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Application\Software\XAMPP\htdocs\ticketin-laravel\resources\views/admin/users.blade.php ENDPATH**/ ?>