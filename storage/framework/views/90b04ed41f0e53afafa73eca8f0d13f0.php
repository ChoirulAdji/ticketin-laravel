...
<div class="wrapper">
  <div class="card">
    ...
    <div class="body">
      <p class="greeting">Halo, <strong><?php echo e($order->user->nama_panggilan); ?></strong>! 👋</p>
      ...
      <div class="order-box">
        ...
        <div class="order-code"><?php echo e($order->order_code); ?></div>
        <div style="display:flex;justify-content:space-between;gap:16px;margin-top:8px;">
          ...
          <div>
            ...
            <div class="value"><?php echo e(strtoupper($order->metode_bayar)); ?></div>
          </div>
        </div>
      </div>

      
      <img src="<?php echo e($order->event->cover_url); ?>" alt="<?php echo e($order->event->judul); ?>" class="event-cover"
      ...
      <div class="info-grid">
        <div class="info-item">
          ...
          <div class="iv"><?php echo e($order->event->tanggal_waktu->translatedFormat('d F Y')); ?></div>
        </div>
        <div class="info-item">
          <div class="icon">🕐</div>
          <div class="il">Jam</div>
          <div class="iv"><?php echo e($order->event->tanggal_waktu->format('H:i')); ?> WIB</div>
        </div>
        <div class="info-item">
          <div class="icon">📍</div>
          <div class="il">Lokasi</div>
          <div class="iv"><?php echo e($order->event->lokasi_kota); ?></div>
        </div>
        <div class="info-item">
          <div class="icon">🏟️</div>
          <div class="il">Venue</div>
          <div class="iv"><?php echo e($order->event->venue); ?></div>
        </div>
      </div>

      <p style="font-size:15px;font-weight:700;color:#111827;margin-bottom:12px;"><?php echo e($order->event->judul); ?></p>
      ...
      <div class="item-row">
        <span><?php echo e($item->ticketCategory->nama_kategori); ?> × <?php echo e($item->qty); ?></span>
        <span style="font-weight:600;">Rp <?php echo e(number_format($item->harga_satuan * $item->qty, 0, ',', '.')); ?></span>
      </div>
      ...
      <div class="item-row" style="color:#6b7280;">
        ...
        <span>Rp <?php echo e(number_format($layanan, 0, ',', '.')); ?></span>
      </div>
      <div class="total-row">
        <span>Total Pembayaran</span>
        <span style="font-size:18px;">Rp <?php echo e(number_format($order->total_harga, 0, ',', '.')); ?></span>
      </div>

      <a href="<?php echo e(url('/profile')); ?>" class="cta">Lihat Detail Pesanan →</a>
    ...
    <div class="footer">
      <p>Email ini dikirim otomatis oleh <a href="<?php echo e(config('app.url')); ?>">TicketIn</a>.<br>
...
<?php /**PATH D:\Application\Software\XAMPP\htdocs\ticketin-laravel\resources\views/emails/orders/confirmation.blade.php ENDPATH**/ ?>