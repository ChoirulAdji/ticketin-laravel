...
<style>
  ...
  .filter-chip.active { background:#102A71; color:#fff; border-color:#102A71; }
  .sort-btn { transition: all .15s; }
  .sort-btn.active { background:#F5C400; color:#001840; font-weight:700; }
  .page-link-active { background:#102A71 !important; color:#fff !important; border-color:#102A71 !important; }
</style>
<?php $__env->stopPush(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Application\Software\XAMPP\htdocs\ticketin-laravel\resources\views/events/index.blade.php ENDPATH**/ ?>