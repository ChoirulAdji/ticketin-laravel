...
<head>
  ...
  <title><?php echo $__env->yieldContent('title','Admin — TicketIn'); ?></title>
...
<body class="flex h-screen overflow-hidden">
  ...
  <aside class="sidebar bg-white border-r border-gray-100 flex flex-col h-screen sticky top-0 overflow-y-auto shadow-sm">
    ...
    <nav class="p-3 flex-1 space-y-1">
      ...
      <a href="<?php echo e(route('admin.events')); ?>" class="sidebar-link <?php echo e(request()->routeIs('admin.events') ? 'active' : ''); ?>">
      ...
      <a href="<?php echo e(route('admin.hero-slider')); ?>"
         class="sidebar-link <?php echo e(request()->routeIs('admin.hero-slider*') ? 'active' : ''); ?>">
      ...
      <a href="<?php echo e(route('admin.laporan')); ?>"
         class="sidebar-link <?php echo e(request()->routeIs('admin.laporan*') ? 'active' : ''); ?>">
        <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"/></svg>
        Laporan Penjualan
      </a>

      <p class="sidebar-section">Verifikasi</p>
      <a href="<?php echo e(route('admin.pengajuan-eo')); ?>" class="sidebar-link <?php echo e(request()->routeIs('admin.pengajuan-eo') ? 'active' : ''); ?>">
        <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
        Verifikasi EO
        <?php $pendingEo = \App\Models\EoApplication::where('status','pending')->count(); ?>
        <?php if($pendingEo > 0): ?>
          <span class="ml-auto text-xs bg-red-500 text-white font-bold px-1.5 py-0.5 rounded-full"><?php echo e($pendingEo); ?></span>
        <?php endif; ?>
      </a>
    </nav>
  ...
  <div class="main-content">
    <div class="sticky top-0 bg-white border-b border-gray-100 z-10 px-6 py-3 flex items-center justify-between">
      <h2 class="font-bold text-navy-deep text-sm"><?php echo $__env->yieldContent('title','Dashboard Admin'); ?></h2>
      <div class="flex items-center gap-3 text-xs text-gray-400">
        <?php if(session('success')): ?>
          <span class="text-green-600 bg-green-50 border border-green-200 px-3 py-1.5 rounded-lg"> <?php echo e(session('success')); ?></span>
        <?php endif; ?>
        <?php if(session('error')): ?>
          <span class="text-red-600 bg-red-50 border border-red-200 px-3 py-1.5 rounded-lg"> <?php echo e(session('error')); ?></span>
        <?php endif; ?>
...
<?php /**PATH C:\xampp\htdocs\ticketin-laravel\resources\views/layouts/admin.blade.php ENDPATH**/ ?>