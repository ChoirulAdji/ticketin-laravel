...
<?php $__env->startSection('content'); ?>
  ...
  <section class="pt-[90px] py-14 bg-gradient-to-br from-navy-deep to-navy-mid text-white">
    <div class="max-w-7xl px-10 py-5 text-left mx-auto">
      ...
      <p class="text-white/80 max-w-2xl">TicketIn adalah platform digital pemesanan tiket event lokal yang dirancang untuk
        memudahkan siapa saja dalam menemukan dan menghadiri event terbaik di sekitar mereka.</p>
    </div>
  </section>
  ...
  <section class="max-w-7xl mx-auto px-6 py-16 space-y-16">
    ...
    <div class="fade-in visible grid md:grid-cols-2 gap-8">
      <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
        ...
        <p class="text-gray-500 leading-relaxed">Menjadi platform tiket event #1 di Indonesia yang memudahkan setiap orang
          untuk menemukan, membeli, dan menikmati pengalaman event terbaik — kapan saja, di mana saja.</p>
      </div>
      <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
        <div class="text-4xl mb-4">🚀</div>
