...
<body class="flex h-screen overflow-hidden">
  ...
  <aside class="sidebar bg-white border-r border-gray-100 flex flex-col h-screen sticky top-0 overflow-y-auto shadow-sm">
    ...
    <nav class="p-3 flex-1 space-y-1">
      ...
      <a href="<?php echo e(route('admin.pesanan')); ?>" class="sidebar-link <?php echo e(request()->routeIs('admin.pesanan') ? 'active' : ''); ?>">
...
<?php /**PATH D:\Application\Software\XAMPP\htdocs\ticketin-laravel\resources\views/layouts/admin.blade.php ENDPATH**/ ?>