...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.C:\xampp\htdocs\ticketin-laravel\public\storage' => 'string',
            'mail.default' => 'string',
...
'hashing.argon.verify','hashing.rehash_on_login','logging.default','logging.deprecations.channel','logging.deprecations.trace',
...
'logging.channels.emergency.path','queue.default','queue.connections.sync.driver','queue.connections.database.driver','queue.connections.database.connection',
...
'services.slack.notifications.channel','view.paths','view.compiled','app.name','app.env',
...
'filesystems.links.C:\\xampp\\htdocs\\ticketin-laravel\\public\\storage','mail.default','mail.mailers.smtp.transport','mail.mailers.smtp.url','mail.mailers.smtp.host',
...
'mail.markdown.theme','mail.markdown.paths','session.driver','session.lifetime','session.expire_on_close',
...
'signed','throttle','verified','pengelola','admin',);
        registerArgumentsSet('routes', 'dashboard','events.index','events.show',
'events.search','hubungi','tentang','register',
'login','logout','profile.index','profile.edit',
'profile.update','profile.password','profile.batalkan','profile.cek-bayar','eo.daftar',
'eo.store','eo.status','wishlist.toggle','wishlist.status','events.review.store',
'events.review.destroy','events.pilih-tiket','checkout.keranjang','checkout.sukses','checkout.show',
'checkout.proses','checkout.konfirmasi','pengelola.dashboard','pengelola.semua-pesanan','pengelola.event.create',
'pengelola.event.store','pengelola.event.edit','pengelola.event.update','pengelola.event.destroy','pengelola.laporan',
'pengelola.laporan.export','pengelola.event.pesanan','pengelola.pesanan.status','admin.dashboard','admin.users',
'admin.users.toggle','admin.users.role','admin.users.hapus','admin.events','admin.events.approve',
'admin.events.reject','admin.hero-slider','admin.hero-slider.store','admin.hero-slider.toggle','admin.hero-slider.urutan',
'admin.hero-slider.destroy','admin.laporan','admin.laporan.export','admin.admin.events.approve','admin.admin.events.reject',
'admin.admin.events.hapus','admin.events.hapus','admin.pengajuan-eo','admin.pengajuan-eo.approve','admin.pengajuan-eo.reject',
'admin.pesanan','admin.pesanan.status',);
        registerArgumentsSet('views', 
'admin.dashboard','admin.events','admin.hero-slider','admin.laporan','admin.pengajuan-eo',
'admin.pesanan','admin.users','auth.login','auth.register','checkout.index',
'checkout.pilih-tiket','checkout.sukses','dashboard.index','emails.orders.confirmation','emails.orders.notif-eo',
'emails.reminder.event','eo.daftar','eo.status','errors.403','errors.404',
'errors.500','events.index','events.show','layouts.admin','layouts.app',
'layouts.auth','layouts.pengelola','pages.hubungi','pages.tentang','pagination::tailwind',
'partials.event-card','pengelola.dashboard','pengelola.form-event','pengelola.laporan','pengelola.pesanan',
'pengelola.semua-pesanan','profile.edit','profile.index','vendor.pagination.tailwind','laravel-exceptions-renderer::components.card',
...
'C:.xampp.htdocs.ticketin-laravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uuid','C:.xampp.htdocs.ticketin-laravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.custom.attribute-name.rule-name','auth.failed','auth.password','auth.throttle',
'validation.accepted','validation.email','validation.max.string','validation.max.file','validation.min.string',
'validation.required','validation.unique','validation.confirmed','validation.string','validation.in',
'validation.image','validation.mimes','validation.date','validation.lowercase','validation.attributes.nama_lengkap',
'validation.attributes.email','validation.attributes.password','validation.attributes.judul','validation.attributes.kategori','validation.attributes.lokasi_kota',
'validation.attributes.venue','validation.attributes.tanggal','validation.attributes.waktu','validation.attributes.gambar_cover','validation.attributes.metode_bayar',);
...
'MAIL_ENCRYPTION','MAIL_FROM_ADDRESS','MAIL_FROM_NAME','MAIL_MAILER','MAIL_HOST',
